...
#define stdin (new std::ContinuousReader(std::access_fd(0, new std::String("r"))))
#define stdout (new std::FileWriter(std::access_fd(1, new std::String("w")), true))
#define stderr (new std::FileWriter(std::access_fd(2, new std::String("w")), true))
